-- USP_Listar_Contratos_v2_Paginado (optimizado - una sola llamada)
DROP PROCEDURE IF EXISTS USP_Listar_Contratos_v2_Paginado2;

CREATE DEFINER=`root`@`localhost` PROCEDURE `USP_Listar_Contratos_v2_Paginado2`(
    IN p_id_empresa INT,
...
BEGIN
    ...
    -- Segundo resultset: Datos paginados
    SELECT
